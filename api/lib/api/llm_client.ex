defmodule Api.LlmClient do
  ...
  def generate_content(prompt) do
    ...
    if is_nil(api_key) or api_key == "" or api_key == "mock_llm_key" do
      # Return a mock reading if no valid key is provided (e.g. during testing)
      {:ok, "오늘은 행운이 가득한 날입니다. 목성과 금성의 기운이 차트에 긍정적으로 작용하고 있습니다. 특히 재물운과 대인관계에서 좋은 흐름이 예상되니, 적극적으로 행동하는 것이 좋습니다."}
    else
